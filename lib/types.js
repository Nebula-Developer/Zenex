...
class ZenexConfig {
    ...
    /**
     * Whether to use node_modules as a static directory (lowest priority)
     */
    useNodeStatic = false;
}
...
class ZenexApp {
    ...
    /**
     * Similar to nodemon - listen for changes and restart the server, sending a refresh signal to all clients.
     * @param {string} path
     */
    listenFileChanges = (path) => {};
}
